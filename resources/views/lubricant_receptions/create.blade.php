            ...
            <form action="{{ route('lubricant-receptions.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <select name="station_product_id" id="station_product_id" class="form-control @error('station_product_id') is-invalid @enderror">
                            ...
                            @foreach($stationProducts as $product)
                                <option value="{{ $product->id }}" {{ old('station_product_id') == $product->id ? 'selected' : '' }}>
                                    {{ $product->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select name="product_packaging_id" id="product_packaging_id" class="form-control @error('product_packaging_id') is-invalid @enderror">
                            <option value="">Sélectionnez un packaging</option>
                            <!-- Options dynamiques -->
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="date" name="date_reception" id="date_reception" class="form-control @error('date_reception') is-invalid @enderror" value="{{ old('date_reception') }}">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="number" name="quantite" id="quantite" class="form-control @error('quantite') is-invalid @enderror" value="{{ old('quantite') }}" step="0.01">
                        @error('quantite')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="number" name="prix_achat" id="prix_achat" class="form-control @error('prix_achat') is-invalid @enderror" value="{{ old('prix_achat') }}" step="0.01">
                        @error('prix_achat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="number" name="prix_vente" id="prix_vente" class="form-control @error('prix_vente') is-invalid @enderror" value="{{ old('prix_vente') }}" step="0.01">
                        @error('prix_vente')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <textarea name="observations" id="observations" class="form-control @error('observations') is-invalid @enderror" rows="1">{{ old('observations') }}</textarea>
                        @error('observations')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
